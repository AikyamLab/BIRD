...
--continue-student runs/celeba/fit-s1/42/clip_clip/checkpoints/latest.pth \
--seed 42 \
--log-dir clip_clip &
...
--fitnet-s2 --vlm clip \
--root runs/celeba/fit-s2 --epochs 8 --lr 0.0001 \
--continue-student runs/celeba/fit-s1/0/clip_clip/checkpoints/latest.pth \
...
--root runs/celeba/fit-s2 --epochs 8 --lr 0.0001 \
--continue-student runs/celeba/fit-s1/123/clip_clip/checkpoints/latest.pth \
--seed 123 \
--log-dir clip_clip &
...
--root runs/celeba/fit-s2 --epochs 8 --lr 0.0001 \
--continue-student runs/celeba/fit-s1/1/clip_clip/checkpoints/latest.pth \
--seed 1 \
--log-dir clip_clip &
...
--root runs/celeba/fit-s2 --epochs 8 --lr 0.0001 \
--continue-student runs/celeba/fit-s1/2/clip_clip/checkpoints/latest.pth \
--seed 2 \
--log-dir clip_clip &